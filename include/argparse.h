...
struct ArgumentResult {
    ...
    const std::string& operator[](const std::string& key) const { return args.at(key); }
};
...
public:
     ...
     */
    void add_keyword_arg(const std::string& short_name, const std::string& long_name, const std::string& action = "",
                         bool required = false, const std::string& _default = "", const std::string& help = "");
     ...
     * '+'.
     */
    void add_positional_arg(const std::string& name, const std::string& narg, const std::string& help);
...
private:
    class KeywordParser {
    public:
        KeywordParser(const std::string& short_name, const std::string& long_name, const std::string& action = "",
                      bool required = false, const std::string& _default = "", const std::string& help = "");
    ...
    public:
        PositionalParser(const std::string& name, const std::string& narg = "1", const std::string& help = "");
